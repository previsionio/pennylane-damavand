...
.. code-block:: bash
    ...
    $ python -m pip install pennylane-damavand
...
.. code-block:: python
    ...
    dev1 = qml.device('damavand.qubit', wires=2, additional_options=10)
...
`plugin usage guide <https://pennylane-damavand.readthedocs.io/en/latest/usage.html>`_ and refer
...
- **Source Code:** https://github.com/previsionio/pennylane-damavand
- **Issue Tracker:** https://github.com/previsionio/pennylane-damavand/issues
